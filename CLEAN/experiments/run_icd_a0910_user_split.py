...
a0910 题量大(17746)，务必 GPU + EduCDM 环境（见 CLEAN/docs/ICD_baseline_repro.md）。
...
运行：cd CLEAN/experiments && python run_icd_a0910_user_split.py [DATA_DIR] [CTX] [STREAM_PER_STAGE]
